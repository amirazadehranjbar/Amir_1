...
List<CategoryModel> categoryList = [
  ...
  CategoryModel(catId: 0, catName: "Category 1", catImage: Assets.images.category.hearingLoss1.path),
  CategoryModel(catId: 1, catName: "Category 2", catImage: Assets.images.category.hearingLoss2.path),
  CategoryModel(catId: 2, catName: "Category 3", catImage: Assets.images.category.hearingLoss3.path),
